...
/// </summary>
public class POtk2dCameraAnchor : MonoBehaviour 
{
	/// <summary>
	/// Anchor.
	/// </summary>
	...
	void Start()
	{
		tk2dCamera = POtk2dContainter.Instance.tkCamera;
		UpdateTransform();
	}
	...
	void UpdateTransform()
	{
		...
		if (tk2dCamera != null)
		{
			...
			switch (anchor)
			{
			case Anchor.LowerLeft: 		anchoredPosition = new Vector3(x_lhs, y_top, position.z); break;
			case Anchor.LowerCenter: 	anchoredPosition = new Vector3(x_ctr, y_top, position.z); break;
			case Anchor.LowerRight: 	anchoredPosition = new Vector3(x_rhs, y_top, position.z); break;
			...
			case Anchor.UpperLeft: 		anchoredPosition = new Vector3(x_lhs, y_bot, position.z); break;
			case Anchor.UpperCenter: 	anchoredPosition = new Vector3(x_ctr, y_bot, position.z); break;
			case Anchor.UpperRight: 	anchoredPosition = new Vector3(x_rhs, y_bot, position.z); break;
			}
